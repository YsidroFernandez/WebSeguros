CREATE TABLE `aseguradora` (
  `codAseguradora` varchar(4) collate utf8_general_ci NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `rif` varchar(255) collate utf8_general_ci NOT NULL,
  `fechaFundacion` date NOT NULL,
  `mision` varchar(600) collate utf8_general_ci NOT NULL,
  `Vision` varchar(600) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `certificadoseguro` (
  ...
  `PolizaDeSeguroCodPoliza` varchar(4) collate utf8_general_ci NOT NULL,
  `Vehiculoplaca` varchar(7) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL default 'A',
...
CREATE TABLE `cita` (
  ...
  `Tomadorcedula` varchar(10) collate utf8_general_ci NOT NULL,
  `fecha` date NOT NULL,
  `comentario` varchar(255) collate utf8_general_ci NOT NULL,
  `SucursalcodSucursal` varchar(4) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`codCita`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=12 ;
...
INSERT INTO `cita` VALUES (7, '-', '2017-03-13', '-', '-', 'E');
INSERT INTO `cita` VALUES (5, '-', '2017-03-11', '-', '-', 'E');
INSERT INTO `cita` VALUES (6, '-', '2017-03-12', '-', '-', 'E');
INSERT INTO `cita` VALUES (8, '-', '2017-03-14', '-', '-', 'E');
INSERT INTO `cita` VALUES (9, '-', '2017-03-15', '-', '-', 'E');
INSERT INTO `cita` VALUES (10, '-', '2017-03-16', '-', '-', 'E');
INSERT INTO `cita` VALUES (11, '-', '2017-03-17', '-', '-', 'E');
...
CREATE TABLE `cliente` (
  `cedula` varchar(10) collate utf8_general_ci NOT NULL,
  `EstadocodEstado` int(10) NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `apellido` varchar(255) collate utf8_general_ci NOT NULL,
  `fechaNacimiento` date NOT NULL,
  `edad` int(10) NOT NULL,
  `direccion` varchar(255) collate utf8_general_ci NOT NULL,
  `telefono` varchar(255) collate utf8_general_ci NOT NULL,
  `e-mail` varchar(20) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL default 'A',
  PRIMARY KEY  (`cedula`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `cliente` VALUES ('2222222222', 17, 'asdasd', 'asdasd', '1999-03-11', 18, 'asdasdasd', '222222222222222', 'sadasdasd@hotmail.co', 'A');
...
CREATE TABLE `cobertura` (
  `codCobertura` varchar(4) collate utf8_general_ci NOT NULL,
  `SegurocodSeguro` varchar(4) collate utf8_general_ci NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `descripcion` varchar(255) collate utf8_general_ci NOT NULL,
  `tipoCobertura` varchar(15) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
INSERT INTO `cobertura` VALUES ('0012', '0002', 'Antitanques', 'Ampara daños causados por un tanque de guerra.', 'Opcional', 'A');
...
CREATE TABLE `coberturaporpoliza` (
  `CoberturacodCobertura` varchar(4) collate utf8_general_ci NOT NULL,
  `PolizaDeSeguroCodPoliza` varchar(4) collate utf8_general_ci NOT NULL,
...
INSERT INTO `coberturaporpoliza` VALUES ('0003', '0003', 1500, 'A');
INSERT INTO `coberturaporpoliza` VALUES ('0004', '0003', 2000, 'A');
INSERT INTO `coberturaporpoliza` VALUES ('0007', '0003', 3500, 'A');
INSERT INTO `coberturaporpoliza` VALUES ('0001', '0003', 500, 'A');
INSERT INTO `coberturaporpoliza` VALUES ('0002', '0003', 1000, 'A');
...
CREATE TABLE `empresaafiliada` (
  `codEmpresa` varchar(4) collate utf8_general_ci NOT NULL,
  `EstadocodEstado` int(10) NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `direccion` varchar(255) collate utf8_general_ci NOT NULL,
  `rif` varchar(255) collate utf8_general_ci NOT NULL,
  `correo` varchar(255) collate utf8_general_ci NOT NULL,
  `telefono` varchar(255) collate utf8_general_ci NOT NULL,
  `nroCuenta` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `estado` (
  ...
  `estado` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL default 'A',
...
CREATE TABLE `factura` (
  `codFactura` int(4) NOT NULL auto_increment,
  `SiniestrocodSiniestro` int(10) NOT NULL,
  `EmpresaAfiliadacodEmpresa` varchar(4) collate utf8_general_ci NOT NULL,
  `TipoServiciocodTipoServicio` varchar(4) collate utf8_general_ci NOT NULL,
  `fecha` date NOT NULL,
...
INSERT INTO `factura` VALUES (1, 5, '0002', '0004', '2017-03-11', 5000, 'Cambio de bujía al motor', 'A');
INSERT INTO `factura` VALUES (2, 5, '0004', '0003', '2017-03-11', 3000, 'Papeleo denuncia', 'A');
INSERT INTO `factura` VALUES (3, 8, '0004', '0005', '2017-03-12', 7000, 'Multa, papeleo', 'A');
...
CREATE TABLE `inspeccion` (
  `codInspeccion` varchar(4) collate utf8_general_ci NOT NULL,
  `SiniestrocodSiniestro` int(10) default NULL,
  `Vehiculoplaca` varchar(7) collate utf8_general_ci default NULL,
  `TipoInspeccioncodTipo` int(10) NOT NULL,
  `EstadocodEstado` int(10) NOT NULL,
  `Usuariocedula` varchar(10) collate utf8_general_ci NOT NULL,
  `fecha` date NOT NULL,
  `lugar` varchar(255) collate utf8_general_ci NOT NULL,
  `evaluacion` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL default 'A',
  `nombreArchivo` varchar(255) collate utf8_general_ci NOT NULL,
...
INSERT INTO `inspeccion` VALUES ('0015', 5, 'Q28-KKE', 2, 16, '26141319', '2017-03-11', 'Prueba', 'sdsadasd', 'A', 'base de datos.sql');
...
CREATE TABLE `marca` (
  `codMarca` varchar(4) collate utf8_general_ci NOT NULL,
  `nombreDeMarca` varchar(255) collate utf8_general_ci NOT NULL,
  `pais` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `modelo` (
  `codModelo` varchar(4) collate utf8_general_ci NOT NULL,
  `MarcaCodMarca` varchar(4) collate utf8_general_ci NOT NULL,
  `nombreModelo` varchar(255) collate utf8_general_ci NOT NULL,
  `annoDelModelo` year(4) NOT NULL,
  `cotizacion` double NOT NULL,
  `tipo` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `polizadeseguro` (
  `codPoliza` varchar(4) collate utf8_general_ci NOT NULL,
  `Vehiculoplaca` varchar(7) collate utf8_general_ci default NULL,
  `Tomadorcedula` varchar(10) collate utf8_general_ci NOT NULL,
...
INSERT INTO `polizadeseguro` VALUES ('0001', 'Q28-KKE', '23746292', 1, '0001', '0000', '2017-03-08', '2018-03-08', 9500, 70000, 'A');
INSERT INTO `polizadeseguro` VALUES ('0003', '2IQ-OQ9', '20123123', 1, '0002', '0000', '2017-03-11', '2018-03-11', 8500, 800000, 'A');
INSERT INTO `polizadeseguro` VALUES ('0002', NULL, '20123123', 2, '0002', '23833676', '2017-03-10', '2018-03-10', 15000, 60000, 'A');
...
CREATE TABLE `seguro` (
  `codSeguro` varchar(4) collate utf8_general_ci NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `descripcion` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `siniestro` (
  ...
  `direccion` varchar(255) collate utf8_general_ci NOT NULL,
  `nombreArchivo` varchar(255) collate utf8_general_ci default NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
INSERT INTO `siniestro` VALUES (5, 6, 'Q28-KKE', 14, '2017-03-08', '2017-03-08', '2017-03-12', 5000, 5000, 8000, 'modificar', NULL, 'C');
INSERT INTO `siniestro` VALUES (7, 5, 'Q28-KKE', 13, '2017-03-12', '2017-03-12', '0000-00-00', 70000, NULL, 0, 'Calle 15', NULL, 'P');
INSERT INTO `siniestro` VALUES (8, 2, '2IQ-OQ9', 17, '2017-03-12', '2017-03-12', '0000-00-00', 60000, NULL, 7000, 'sadasd', NULL, 'P');
INSERT INTO `siniestro` VALUES (9, 2, 'KKK-123', 17, '2017-03-12', '2017-03-12', '0000-00-00', 0, NULL, 0, 'Callejón 23', NULL, 'P');
...
CREATE TABLE `sucursal` (
  `codSucursal` varchar(4) collate utf8_general_ci NOT NULL,
  `AseguradoracodAseguradora` varchar(10) collate utf8_general_ci NOT NULL,
  `EstadocodEstado` int(10) NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `direccion` varchar(255) collate utf8_general_ci NOT NULL,
  `telefono` varchar(255) collate utf8_general_ci NOT NULL,
  `e-mail` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `tiposervicio` (
  `codTipoServicio` varchar(10) collate utf8_general_ci NOT NULL,
  `nombre` varchar(255) collate utf8_general_ci NOT NULL,
  `descripcion` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL,
...
CREATE TABLE `tipovehiculo` (
  `codTipo` int(10) NOT NULL auto_increment,
  `nombreTipo` varchar(255) collate utf8_general_ci NOT NULL,
  `estatus` char(1) collate utf8_general_ci NOT NULL default 'A',
  PRIMARY KEY  (`codTipo`)
...
CREATE TABLE `vehiculo` (
  `placa` varchar(7) collate utf8_general_ci NOT NULL,
  `ModelocodModelo` varchar(4) collate utf8_general_ci NOT NULL,
  `Aseguradocedula` varchar(10) collate utf8_general_ci NOT NULL,
  `EstadocodEstado` int(10) NOT NULL,
  `TipoVehiculoCodTipo` int(10) NOT NULL,
  `color` varchar(255) collate utf8_general_ci NOT NULL,
  `serial` varchar(255) collate utf8_general_ci NOT NULL,
...
INSERT INTO `vehiculo` VALUES ('2IQ-OQ9', '0003', '20300400', 23, 8, 'Gris', '212321i23u2332', 30, 'A');
